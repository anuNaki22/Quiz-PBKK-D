...
<head>
	...
	<meta charset="utf-8">
	<meta name="description" content="Tiket Pesawat">
	...
	<link rel="shortcut icon" href="<?= base_url('assets/img/logo_tipes.png');?>">
            ...
            <div class="navbar-header" style="width:100%;">
              <div class="opener-left-menu is-open">
                ...
                <a href="<?= base_url();?>" class="navbar-brand">
                 <img src="<?= base_url('assets/img/logo_tipes.png');?>" alt="Tipes Logo" class="logo">
                 <b style="text-transform: uppercase;">Tiket Pesawat</b>
                </a>

              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span><?= $this->session->userdata['user']; ?></span></li>
                  <li class="dropdown avatar-dropdown">
                   <img src="<?= base_url('assets/img/avatar.png');?>" class="img-circle avatar" alt="user name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"/>
